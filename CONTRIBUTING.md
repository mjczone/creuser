# Contributing to Creuser

Thank you for your interest in contributing to Creuser! 🎉

## 🚧 Current Project Status

**This tool is currently in active development and early versions (0.x.x).** While we appreciate community interest, please be aware that:
...
2. **Minimal reproduction code** that demonstrates the issue
...
- **Documentation** - Check [our docs](https://mjczone.github.io/creuser/) first
...
**Thank you for your interest in Creuser!**

Even though we're limiting code contributions during this development phase, your feedback, ideas, and issue reports are invaluable in helping us build a better tool. 🚀
