...
export const AccessorFieldDtoSchema = {
  required: ['name', 'description', 'returnType'],
  type: 'object',
  properties: {
    name: {
      type: 'string',
...
export const AccessorNamespaceDtoSchema = {
  required: ['namespace', 'description', 'fields'],
  type: 'object',
  properties: {
    namespace: {
      type: 'string',
    ...
    fields: {
      type: 'array',
      items: {
        $ref: '#/components/schemas/AccessorFieldDto',
      },
    },
  },
} as const;
...
export const ApiResultOfConventionCapabilitiesResultSchema = {
  required: ['result'],
  type: 'object',
  properties: {
    result: {
      oneOf: [
        ...
        {
          $ref: '#/components/schemas/ConventionCapabilitiesResult',
        },
      ],
    },
  },
...
export const ApiResultOfEntityRelationshipsResultSchema = {
  required: ['result'],
  type: 'object',
  properties: {
    result: {
      oneOf: [
        ...
        {
          $ref: '#/components/schemas/EntityRelationshipsResult',
        },
      ],
    },
  },
...
export const ApiResultOfIReadOnlyListOfMemberResultSchema = {
  required: ['result'],
  type: 'object',
  properties: {
    result: {
...
export const ApiResultOfMemberResultSchema = {
  required: ['result'],
  type: 'object',
  properties: {
    result: {
...
export const ApiResultOfRelationshipEditResultDtoSchema = {
  required: ['result'],
  type: 'object',
  properties: {
    result: {
      oneOf: [
        ...
        {
          $ref: '#/components/schemas/RelationshipEditResultDto',
        },
      ],
    },
  },
...
export const ApiResultOfTestConventionResultDtoSchema = {
  required: ['result'],
  type: 'object',
  properties: {
    result: {
      oneOf: [
        ...
        {
          $ref: '#/components/schemas/TestConventionResultDto',
        },
      ],
    },
  },
...
export const ApiResultOfValidateConventionResultSchema = {
  required: ['result'],
  type: 'object',
  properties: {
    result: {
      oneOf: [
        ...
        {
          $ref: '#/components/schemas/ValidateConventionResult',
        },
      ],
    },
  },
...
export const CommonPatternDtoSchema = {
  required: ['id', 'description', 'yamlSnippet'],
  type: 'object',
  properties: {
    id: {
      type: 'string',
...
export const ConventionCapabilitiesResultSchema = {
  required: [
    'schemaUrl',
    'schemaVersion',
    'schema',
  ...
  properties: {
    ...
    accessors: {
      type: 'array',
      items: {
        $ref: '#/components/schemas/AccessorNamespaceDto',
      },
    },
    workspaceKinds: {
      type: 'array',
    ...
    refSourceKinds: {
      type: 'array',
      items: {
        $ref: '#/components/schemas/RefSourceKindDto',
      },
    },
    filterKinds: {
      type: 'array',
      items: {
        $ref: '#/components/schemas/FilterKindDto',
      },
    },
    commonPatterns: {
      type: 'array',
      items: {
        $ref: '#/components/schemas/CommonPatternDto',
      },
    },
  },
} as const;
...
export const ConventionRelationshipSummarySchema = {
  required: [
    'kind',
    'name',
    'icon',
...
export const ConventionSummarySchema = {
  ...
  properties: {
    ...
    relationships: {
      type: 'array',
      items: {
        $ref: '#/components/schemas/ConventionRelationshipSummary',
      },
    },
  },
} as const;
...
export const EntityRelationshipFolderSchema = {
  required: ['kind', 'name', 'icon', 'description', 'order', 'direction', 'items'],
  type: 'object',
  properties: {
    kind: {
      type: 'string',
    ...
    items: {
      type: 'array',
      items: {
        $ref: '#/components/schemas/EntityRelationshipItem',
      },
    },
  },
} as const;

export const EntityRelationshipItemSchema = {
  required: ['entityId', 'kind', 'slug', 'path', 'metadataKind', 'url', 'raw', 'expandedFrom'],
  type: 'object',
  properties: {
    entityId: {
      type: ['null', 'string'],
...
export const EntityRelationshipsResultSchema = {
  required: ['entityId', 'kind', 'slug', 'path', 'folders'],
  type: 'object',
  properties: {
    entityId: {
      type: 'string',
    ...
    folders: {
      type: 'array',
      items: {
        $ref: '#/components/schemas/EntityRelationshipFolder',
      },
    },
  },
} as const;
...
export const FilterKindDtoSchema = {
  required: ['kind', 'description', 'patternExample'],
  type: 'object',
  properties: {
    kind: {
      type: 'string',
...
export const MemberResultSchema = {
  required: ['userId', 'email', 'displayName', 'role', 'grantedAt', 'grantedBy', 'isActive'],
  type: 'object',
  properties: {
    userId: {
      type: 'string',
...
export const RefSourceKindDtoSchema = {
  required: ['kind', 'description', 'example'],
  type: 'object',
  properties: {
    kind: {
      type: 'string',
...
export const RelationshipEditRequestSchema = {
  required: [
    'kind',
    'name',
    'icon',
...
export const RelationshipEditResultDtoSchema = {
  required: ['conventionId', 'resultingYaml', 'relationshipCount'],
  type: 'object',
  properties: {
    conventionId: {
      type: 'string',
...
export const TestConventionRequestSchema = {
  required: ['againstPath'],
  type: 'object',
  properties: {
    againstPath: {
      type: 'string',
...
export const TestConventionResultDtoSchema = {
  required: ['matched', 'entity', 'refs', 'error'],
  type: 'object',
  properties: {
    matched: {
      type: 'boolean',
...
export const ValidateConventionRequestSchema = {
  required: ['yaml'],
  type: 'object',
  properties: {
    yaml: {
...
export const ValidateConventionResultSchema = {
  required: ['isValid', 'convention', 'errors'],
  type: 'object',
  properties: {
    isValid: {
      type: 'boolean',
